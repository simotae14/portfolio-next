...
import myImg from "@/public/simo.png";
...
export default function Intro() {
  return (
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0'>
      ...
      >
        <span className="font-bold">Hello, I'm Simone.</span> I'm a{" "}
      ...
      >
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10" href="/CV.pdf" download
        ...
        <a 
          ...
          href="https://www.linkedin.com/in/simone-taeggi/"
          target='_blank'
        >
          <BsLinkedin />
        </a>
        ...
        <a 
          ...
          href="https://github.com/simotae14"
          target='_blank'
        >
          <FaGithubSquare />
        </a>
